...
This is a network restriction in the Claude Code cloud environment, not an issue with the Railway deployment itself. This has been failing since at least 2026-09-06.
...
- Or, in Claude Code settings, change the network policy to one that allows external API calls

**Option 3 — Check the Railway dashboard directly:**
...
---
*Scheduled task ran at 2026-09-07 01:10 UTC. Same block as 2026-09-06 — proxy policy unchanged.*
